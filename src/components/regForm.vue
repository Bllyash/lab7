        ...
        <div class="row">
          ...
          <div class="col-lg-6 col-sm-12">
            ...
            <div class="mb-3">
              ...
              <div class="form-check">
                <input class="form-check-input" v-model="registrant.gender" type="radio" name="gender" id="Helicopter" value="AH-64 Attack Helicopter">
                <label class="form-check-label" for="Helicopter">AH-64 Attack helicopter</label>
              </div>
              <div class="invalid-feedback">
